...
include("data/house_sales_data.jl")
include("data/population_data.jl")
include("data/vehicle_miles_data.jl")
include("data/temperature_data.jl")
include("data/iris_data.jl")
include("data/ozone_data.jl")
include("data/regularized_fit_data.jl")
include("data/portfolio_data.jl")
